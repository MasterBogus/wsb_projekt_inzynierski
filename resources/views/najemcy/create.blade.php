...
<div class="sidebar">
    ...
    <form enctype="multipart/form-data" action="{{ route('najemcy.store') }}" method="post" accept-charset="utf-8">
    @csrf
    
        <div class="text-center rounded color">
            <h1 class="headerForm">Podaj informacje o nowym najemcy</h1>
        ...
        <div class="row no-gutters mb-2">
            ...
            <div class="color ml-auto">
                <input id="imie_najemcy" type="text" class="form-control" name="imie_najemcy" value="" required>
        ...
        <div class="row no-gutters mb-2">
            ...
            <div class="color ml-auto">
                <input id="nazwisko_najemcy" type="text" class="form-control" name="nazwisko_najemcy" value="" required>
        ...
        <div class="row no-gutters mb-2">
            ...
            <div class="color ml-auto">
                <input id="kod_pocztowy_najemcy" type="text" class="form-control" name="kod_pocztowy_najemcy" value="" required>
        ...
        <div class="row no-gutters mb-2">
            ...
            <div class="color ml-auto">
                <input id="miasto_najemcy" type="text" class="form-control" name="miasto_najemcy" value="" required>
        ...
        <div class="row no-gutters mb-2">
            <label for="adres_najemcy" class="col-form-label">Adres zameldowania: </label>
            <div class="color ml-auto">
                <input id="adres_najemcy" type="text" class="form-control" name="adres_najemcy" value="" required>
        ...
        <div class="row no-gutters mb-2">
            ...
            <div class="color ml-auto">
                <input id="nr_pesel" type="text" class="form-control" name="nr_pesel" value="" required>
        ...
        <div class="row no-gutters mb-2">
            <label for="nr_tel_najemcy" class="col-form-label">Numer telefonu najemcy: </label>
            <div class="color ml-auto">
                <input id="nr_tel_najemcy" type="text" class="form-control" name="nr_tel_najemcy" value="" required>
